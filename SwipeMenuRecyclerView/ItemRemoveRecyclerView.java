...
public class ItemRemoveRecyclerView extends RecyclerView {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        RelayMessageAdapter.RelayViewHolder viewHolder;
        switch (e.getAction()) {
...
//                    <item android:drawable="@color/unpressed" android:state_pressed="false"/>
//                    <item android:drawable="@color/pressed" android:state_pressed="true" />
                    /*selector 和 点击冲突了,无效果，此处用代码来控制*/
                    view.setBackgroundColor(Color.parseColor("#F1F0F0"));
                    viewHolder = (RelayMessageAdapter.RelayViewHolder) getChildViewHolder(view);

                    mItemLayout = viewHolder.layout;
                    mPosition = viewHolder.getAdapterPosition();

                    mDelete = (TextView) mItemLayout.findViewById(R.id.message_item_delete);
